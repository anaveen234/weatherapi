    ...
    function updatePage(responseText) {
      ...
      let tableHtml = "<table align='center' border='1'><thead><tr><th colspan='4'>" + cityName + " Weather Forecast for "+ duration + " days</th></tr><tr><th>Date</th><th>Time</th><th>Temperature (C)</th><th>Weather</th></tr></thead><tbody>";
